...
<main id="maincontent" role="main">
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <?php if( get_theme_mod('vw_book_store_slider_title_hide_show',true) != ''){ ?>
                    <h1 class="<?php if( get_theme_mod( 'vw_book_store_animation', true) != '') { ?> wow zoomInUp delay-1000" data-wow-duration="2s"<?php } else { ?> heading <?php } ?>"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
                  <?php }?>
                  <?php if( get_theme_mod('vw_book_store_slider_content_hide_show',true) != ''){ ?>
                    <p class="<?php if( get_theme_mod( 'vw_book_store_animation', true) != '') { ?> wow zoomInDown delay-1000" data-wow-duration="2s"<?php } else { ?> cont <?php } ?>"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_book_store_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_book_store_slider_excerpt_number','30')))); ?></p>
                  <?php } ?>
                  <?php if( get_theme_mod('vw_book_store_slider_button_text','READ MORE') != ''){ ?>
                    <div class="<?php if( get_theme_mod( 'vw_book_store_animation', true) != '') { ?> more-btn wow zoomInDown delay-1000" data-wow-duration="2s"<?php } else { ?> more-btn <?php } ?>">
  ...
  <section id="book-store" class="<?php if( get_theme_mod( 'vw_book_store_animation', true) != '') { ?> wow zoomInDown delay-1000" data-wow-duration="2s"<?php } else { ?> books <?php } ?>">
    <div class="container">
